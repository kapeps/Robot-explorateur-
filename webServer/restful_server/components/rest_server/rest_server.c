...
static esp_err_t light_brightness_post_handler(httpd_req_t *req)
{
    ...
    ESP_LOGI(REST_TAG, "Light brightness: red = %d, green = %d, blue = %d", red, green, blue);
    cJSON_Delete(root);
...
static esp_err_t led_post_handler(httpd_req_t *req)
{
    ...
    cJSON *root = cJSON_Parse(buf);
    onTime = cJSON_GetObjectItem(root, "onTime")->valueint;
    offTime = cJSON_GetObjectItem(root, "offTime")->valueint;
    ESP_LOGI(REST_TAG, "Blink control : onTime = %d, offTime = %d", onTime, offTime);
    cJSON_Delete(root);
    httpd_resp_sendstr(req, "Post control value successfully");
    return ESP_OK;
}
